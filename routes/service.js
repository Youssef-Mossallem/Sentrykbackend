...
// الخيار الأول: قراءة ملف الـ JSON الخارجي من الجذر (Root) لحرية التعديل المستقبلي
...
if (!googleCredentials) {
  console.log(`⚠️ [Sentryk Indexing Engine]: لم يتم العثور على ملف خارجي. جاري التحميل من البيانات المدمجة يدويًا...`);
  
  googleCredentials = {
    client_email: "indexing-bot@sentryk2026.iam.gserviceaccount.com",
    // تم تمرير المفتاح الخاص كاملاً ومباشرة مع معالجة الـ Newlines بدقة
...
// بناء وتكوين عميل JWT بناءً على البيانات المتوفرة
let jwtClient = null;
